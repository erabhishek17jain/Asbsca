...
const Others = ({ payloads, setBussDetails }: any) => {
    ...
    <>
      <ASection>
        <ol type="1" style={{ listStyle: 'auto' }} className="pl-4">
          ...
          <li className="mb-2">
            <div className="flex gap-2 sm:w-[60%]">
              They are engaged in business of{' '}
              <input
                type={'text'}
                id={'value.engaged'}
                onChange={handleChange}
          ...
          <li className="mb-2">
            <div className="flex gap-2 sm:w-[60%]">
              Price Range of products/services are between.{' '}
              <input
                type={'text'}
                id={'value.serCharge'}
                onChange={handleChange}
          ...
          <li className="mb-2">
            <div className="flex gap-2 sm:w-[60%]">
              How do they market there products/services?
              <input
                type={'text'}
                id={'value.marketSer'}
                onChange={handleChange}
