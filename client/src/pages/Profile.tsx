          ...
          <>
            <div className="relative z-20 h-30">
              <div className="absolute top-4 right-4 z-10 xsm:bottom-4 xsm:right-4">
                <label
                  htmlFor="cover"
                  className="flex cursor-pointer items-center justify-center gap-2 rounded bg-[#02385e] py-1 px-2 text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4"
                >
                  <span>
                    <svg
            ...
            <div className="p-7">
              <form action="#">
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="fullName"
                        id="fullName"
                        placeholder="Danish Heilium"
                        defaultValue="Danish Heilium"
                      />
                    </div>
                  </div>
                ...
                <div className="flex justify-end gap-4.5">
                  ...
                  <button
                    className="flex justify-center rounded bg-[#02385e] py-2 px-6 font-medium text-gray hover:shadow-1"
                    type="submit"
                    onClick={fireToast}
                  >
                    Save
